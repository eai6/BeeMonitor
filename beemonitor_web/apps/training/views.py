...
# Domain-drift detection (DINOv3 embeddings on the SAM 3 endpoint) was removed
# 2026-07-14 to cut g5 GPU spend — the auto-adaptation loop it fed was already
# UI-hidden in favour of manual fine-tuning. The DriftReference/DriftCheck
# models are left in place (dormant) so no destructive migration is needed.
